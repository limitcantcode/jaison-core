...
args.add_argument('-h', '--host', default='127.0.0.1', type=str, help='IP to use as host API and websocket server on. Try 0.0.0.0 for cross machine access to API.')
args.add_argument('-p', '--port', default=7272, type=int, help='Post to host API and websocket server on.')
